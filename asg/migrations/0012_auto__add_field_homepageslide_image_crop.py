...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HomepageSlide.image_crop'
        db.add_column(u'asg_homepageslide', 'image_crop',
                      self.gf(u'django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HomepageSlide.image_crop'
        db.delete_column(u'asg_homepageslide', 'image_crop')
