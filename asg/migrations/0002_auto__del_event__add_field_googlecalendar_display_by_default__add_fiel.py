...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GoogleCalendar.display_by_default'
        db.add_column(u'asg_googlecalendar', 'display_by_default',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'GoogleCalendar.show_on_homepage'
        db.add_column(u'asg_googlecalendar', 'show_on_homepage',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Person.netid'
        db.add_column(u'asg_person', 'netid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=6, blank=True),
                      keep_default=False)

        # Adding field 'Person.active'
        db.add_column(u'asg_person', 'active',
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'asg_event', (
            ...
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(related_name='office_hours', null=True, to=orm['asg.Person'], blank=True)),
            ('location', self.gf('django.db.models.fields.CharField')(max_length=455, blank=True)),
        ))
        db.send_create_signal(u'asg', ['Event'])

        # Deleting field 'GoogleCalendar.display_by_default'
        db.delete_column(u'asg_googlecalendar', 'display_by_default')

        # Deleting field 'GoogleCalendar.show_on_homepage'
        db.delete_column(u'asg_googlecalendar', 'show_on_homepage')

        # Deleting field 'Person.netid'
        db.delete_column(u'asg_person', 'netid')

        # Deleting field 'Person.active'
        db.delete_column(u'asg_person', 'active')


        # Changing field 'Person.photo'
        db.alter_column(u'asg_person', 'photo', self.gf('django.db.models.fields.files.FileField')(max_length=100))
    ...
    models = {
        ...
        u'asg.googlecalendar': {
            ...
            'display_by_default': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
