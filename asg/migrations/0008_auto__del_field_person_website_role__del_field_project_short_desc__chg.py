...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Person.website_role'
        db.delete_column(u'asg_person', 'website_role')
        ...
        db.alter_column(u'asg_project', 'description', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):
        # Adding field 'Person.website_role'
        db.add_column(u'asg_person', 'website_role',
        ...
        # Changing field 'Project.description'
        db.alter_column(u'asg_project', 'description', self.gf('tinymce.models.HTMLField')())
