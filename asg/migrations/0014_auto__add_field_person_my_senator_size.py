...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.my_senator_size'
        db.add_column(u'asg_person', 'my_senator_size',
                      self.gf(u'django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.my_senator_size'
        db.delete_column(u'asg_person', 'my_senator_size')
    ...
    models = {
        ...
        u'asg.person': {
            ...
            'my_senator_size': (u'django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
