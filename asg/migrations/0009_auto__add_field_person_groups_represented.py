...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.groups_represented'
        db.add_column(u'asg_person', 'groups_represented',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.groups_represented'
        db.delete_column(u'asg_person', 'groups_represented')
