...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GoogleCalendar.is_public'
        db.delete_column(u'asg_googlecalendar', 'is_public')

        # Adding field 'GoogleCalendar.display_on_calendar_page'
        db.add_column(u'asg_googlecalendar', 'display_on_calendar_page',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Resource.page'
        db.add_column(u'asg_resource', 'page',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['asg.Page'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'GoogleCalendar.is_public'
        db.add_column(u'asg_googlecalendar', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'GoogleCalendar.display_on_calendar_page'
        db.delete_column(u'asg_googlecalendar', 'display_on_calendar_page')

        # Deleting field 'Resource.page'
        db.delete_column(u'asg_resource', 'page_id')
