...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ApprovedUser.position'
        db.alter_column(u'asg_approveduser', 'position_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['asg.Position'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ApprovedUser.position'
        raise RuntimeError("Cannot reverse this migration. 'ApprovedUser.position' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'ApprovedUser.position'
        db.alter_column(u'asg_approveduser', 'position_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['asg.Position']))
    ...
    models = {
        ...
        u'asg.approveduser': {
            ...
            'position': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['asg.Position']", 'null': 'True', 'blank': 'True'})
        },
        u'asg.committee': {
        ...
        u'asg.homepageslide': {
            ...
            'image_crop': (u'django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
        ...
        u'asg.person': {
            ...
            'full_groups': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'groups_represented': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
