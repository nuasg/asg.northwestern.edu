...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Resource.logo_image'
        db.alter_column(u'asg_resource', 'logo_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
        # Adding field 'Position.email'
        db.add_column(u'asg_position', 'email',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Resource.logo_image'
        db.alter_column(u'asg_resource', 'logo_image', self.gf('django.db.models.fields.files.FileField')(max_length=100))
        # Deleting field 'Position.email'
        db.delete_column(u'asg_position', 'email')
