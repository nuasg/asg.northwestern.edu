...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.full_groups'
        db.add_column(u'asg_person', 'full_groups',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Resource.is_active'
        db.add_column(u'asg_resource', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.full_groups'
        db.delete_column(u'asg_person', 'full_groups')

        # Deleting field 'Resource.is_active'
        db.delete_column(u'asg_resource', 'is_active')
