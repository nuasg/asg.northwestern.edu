...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Project.committee'
        db.delete_column(u'asg_project', 'committee_id')

        # Adding field 'Project.short_desc'
        db.add_column(u'asg_project', 'short_desc',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Project.active'
        db.add_column(u'asg_project', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding M2M table for field committees on 'Project'
        m2m_table_name = db.shorten_name(u'asg_project_committees')
        ...
        db.create_unique(m2m_table_name, ['project_id', 'committee_id'])


    def backwards(self, orm):
        # Adding field 'Project.committee'
        db.add_column(u'asg_project', 'committee',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['asg.Committee'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Project.short_desc'
        db.delete_column(u'asg_project', 'short_desc')

        # Deleting field 'Project.active'
        db.delete_column(u'asg_project', 'active')

        # Removing M2M table for field committees on 'Project'
        db.delete_table(db.shorten_name(u'asg_project_committees'))
    ...
    models = {
        ...
        u'asg.approveduser': {
            'Meta': {'object_name': 'ApprovedUser'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'netid': ('django.db.models.fields.CharField', [], {'max_length': '6'}),
            'position': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['asg.Position']"})
        },
        u'asg.committee': {
        ...
        u'asg.person': {
            ...
            'photo': (u'django.db.models.fields.files.ImageField', [], {'default': "'settings.MEDIA_ROOT/profile_photos/default.jpg'", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'positions': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['asg.Position']", 'symmetrical': 'False', 'blank': 'True'}),
            'thumbnail_size': (u'django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
        ...
        u'asg.project': {
            ...
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'committees': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['asg.Committee']", 'null': 'True', 'blank': 'True'}),
