...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ApprovedUser'
        db.create_table(u'asg_approveduser', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('netid', self.gf('django.db.models.fields.CharField')(max_length=6)),
            ('position', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['asg.Position'])),
        ))
        db.send_create_signal(u'asg', ['ApprovedUser'])

        # Adding field 'Person.thumbnail_size'
        db.add_column(u'asg_person', 'thumbnail_size',
                      self.gf(u'django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


        # Changing field 'Person.photo'
        db.alter_column(u'asg_person', 'photo', self.gf(u'django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):
        # Deleting model 'ApprovedUser'
        db.delete_table(u'asg_approveduser')

        # Deleting field 'Person.thumbnail_size'
        db.delete_column(u'asg_person', 'thumbnail_size')
        ...
        # Changing field 'Person.photo'
        db.alter_column(u'asg_person', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
